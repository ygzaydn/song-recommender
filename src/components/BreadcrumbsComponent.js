...
const BreadcrumbsComponent = ({
    ...
    const handleClickMenu = (statefunction) => (event) =>
        statefunction(event.currentTarget);
        ...
        <div className={classTrigger}>
            <Breadcrumbs classes={{ ol: classes.ol }} aria-label="breadcrumb">
                <Typography
                    id="header"
                    className={
                        classnames === "ArtistInfo" ||
                        classnames === "ArtistRecommend"
                            ? classes.underlineTypo
                            : classes.root
                    }
                    aria-controls="artist-menu"
                    color="inherit"
                    onClick={handleClickMenu(setanchorElArtists)}
                >
                    Artists
                ...
                <Typography
                    id="header1"
                    className={
                        classnames === "TrackInfo" ||
                        classnames === "TrackSearch"
                            ? classes.underlineTypo
                            : classes.root
                    }
                    aria-controls="track-menu"
                    color="inherit"
                    onClick={handleClickMenu(setanchorElTracks)}
                >
                    Tracks
                    <ExpandMoreIcon color="white" fontSize="small" />
                </Typography>
                <Typography
                    ...
                    className={
                        classnames === "TagInfo" ||
                        classnames === "TagRecommend"
                            ? classes.underlineTypo
                            : classes.root
                    }
                    aria-controls="tag-menu"
                    color="inherit"
                    onClick={handleClickMenu(setanchorElTags)}
                >
                    Tags
                    <ExpandMoreIcon color="white" fontSize="small" />
                </Typography>
                <Typography
                    id="header3"
                    className={
                        classnames === "GeoTopArtist" ||
                        classnames === "GeoTopTrack"
                            ? classes.underlineTypo
                            : classes.root
                    }
                    color="inherit"
                    aria-controls="geo-menu"
                    onClick={handleClickMenu(setanchorElGeos)}
                >
                    Geo
                    <ExpandMoreIcon color="white" fontSize="small" />
                </Typography>
            ...
            <Menu
                ...
                onClose={() => {
                    handleClose(setanchorElArtists);
                }}
            ...
            >
                ...
                >
                    ...
                    <MenuItem
                        ...
                        onClick={handleClick("Artist", "ArtistInfo")}
                    >
                        <ListItemIcon>
                    ...
                    <MenuItem
                        onClick={handleClick("Artist", "ArtistRecommend")}
                        className={classes.menuItemStyle}
                    >
                        <ListItemIcon>
            ...
            >
                ...
                >
                    ...
                    <MenuItem
                        className={classes.menuItemStyle}
                        onClick={handleClick("Track", "TrackInfo")}
                    >
                        <ListItemIcon>
            ...
            >
                ...
                >
                    ...
                    <MenuItem
                        className={classes.menuItemStyle}
                        onClick={handleClick("Tag", "TagInfo")}
                    >
                        <ListItemIcon>
                            <QueueMusicIcon style={{ color: "white" }} />
                        </ListItemIcon>
                    ...
                    <MenuItem
                        onClick={handleClick("Tag", "TagRecommend")}
                        className={classes.menuItemStyle}
                    >
                        <ListItemIcon>
                            <LibraryMusicIcon style={{ color: "white" }} />
            ...
            >
                ...
                >
                    ...
                    <MenuItem
                        className={classes.menuItemStyle}
                        onClick={handleClick("Geo", "GeoTopArtist")}
                    >
                        <ListItemIcon>
                            <QueueMusicIcon style={{ color: "white" }} />
                        </ListItemIcon>
                    ...
                    <MenuItem
                        onClick={handleClick("Geo", "GeoTopTrack")}
                        className={classes.menuItemStyle}
                    >
                        <ListItemIcon>
                            <AlbumSharpIcon style={{ color: "white" }} />
...
export const ConnectedBreadcrumbsComponent = connect(
    mapStateToProps,
    mapDispatchToProps
