...
const TagInfo = ({
    ...
    return (
        <div className={classes.root}>
            {tagState.getTag &&
            tagState.getTopAlbumTags &&
            tagState.getTopArtistTags &&
            tagState.getTopTrackTags ? (
                <Paper className={classes.paper}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} className={classes.collapseStyle}>
                            ...
                            <Collapse in={checked} collapsedSize={150}>
                                <Typography className={classes.bio}>
                                    {
                                        tagState.getTag.wiki.content.split(
                                            "<a hr"
                                        )[0]
                                    }
                                </Typography>
                        ...
                        <Grid item xs={6}>
                            <GridList className={classes.gridList} cols={1}>
                                <ConnectedSmallCard
                                    clickInfo={false}
                                    title="Stats"
                                    data1={tagState.getTag.reach}
                                    data2={tagState.getTag.total}
                                    par1="Reach"
                                    par2="Total"
                                    stats={true}
                                />
                        ...
                        <Grid item xs={6}>
                            <GridList className={classes.gridList} cols={1}>
                                <ConnectedSmallCard
                                    data1={tagState.getTopArtistTags}
...
export const ConnectedTagInfo = connect(
    mapStateToProps,
    mapDispatchToProps
)(TagInfo);
