...
const SmallCard = ({
    ...
    const classNameForContent = clickInfo
        ? classes.rootTitle1
        : classes.rootTitle2;
            ...
            <CardContent className={classNameForContent}>
                          ...
                          return (
                              <div className={classes.similarArtistLine}>
                                  ...
                                  <ChevronRightIcon
                                      ...
                                      fontSize="large"
                                      onClick={() => clickInfoFunction(el.name)}
                                  />
                              </div>
                          );
                      })
                ...
                {stats === true ? (
                    <div style={{ alignSelf: "center", justifySelf: "center" }}>
                        <Typography className={classes.pos}>{par1}</Typography>
                        <Typography className={classes.moreInfo}>
                            {data1}
                        </Typography>
                        <Typography className={classes.pos}>{par2}</Typography>
                        <Typography className={classes.moreInfo}>
                            {data2}
                        </Typography>
                    </div>
...
export const ConnectedSmallCard = connect(
    mapStateToProps,
    mapDispatchToProps
)(SmallCard);
