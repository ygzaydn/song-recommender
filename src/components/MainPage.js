...
const MainPage = ({ renderState }) => {
    ...
    return (
        <div className={classes.root}>
            ...
            {renderState === "ArtistInfo" ? <ConnectedArtistInfo /> : null}
            {renderState === "TrackSearch" ? <ConnectedRecommendTrack /> : null}
            {renderState === "TrackInfo" ? <ConnectedTrackInfo /> : null}
            {renderState === "TagInfo" ? <ConnectedTagInfo /> : null}
            {renderState === "TagRecommend" ? <ConnectedRecommendTag /> : null}
            {renderState === "GeoTopArtist" ? <ConnectedGeoTopArtist /> : null}
            {renderState === "GeoTopTrack" ? <ConnectedGeoTopTrack /> : null}
        </div>
    );
};
